# Design Engineer — Phase Routing Table

This table is consumed by the orchestrator at the start of every run and auto-refreshed each session (the orchestrator re-scans installed skills and slots new ones in).
